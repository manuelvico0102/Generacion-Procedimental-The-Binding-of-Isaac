...
class Level:
    ...
    def __init__(self,
                 ...
                 main_hero: Player,
                 level_map: list[list[consts.RoomsTypes | str]] = [],
                 width: int = 10,
                 height: int = 6):
        ...
        self.width = width
        self.height = height
        self.level_map: level_map                        # es como una matriz donde indica el tipo de habitacion
        self.rooms: list[list[Room | None]] = [[None] * width for _ in range(height)]   # crea como otra matriz de 10x6 donde pone las habitaciones a None
    ...
    def setup_level(self):
        ...
        """
        nrooms = self.get_number_of_rooms(self.floor_type)
        self.level_map = generate_level(self.width, self.height, nrooms)
